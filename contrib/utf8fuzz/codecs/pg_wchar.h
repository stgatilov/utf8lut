// see licensing info in postgresql.c

// some misc postgresql header stuff
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
#include <string.h>
...
#define ERROR (0)
#define ereport elog
#define errcode(x) ((void)0)

static inline void elog(int a, ...) { return; }

static inline const char* errmsg(const char* b, ...) { return 0; }
...
extern int pg_verify_mbstr_len(int encoding, const char *mbstr, int len,
					bool noError, bool HackyEnableNullByte);
